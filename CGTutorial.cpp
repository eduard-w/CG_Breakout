...
float angleY = 0.0f;
float angleZ = 0.0f;
float angleLampZ = 0.0f;
float angleLamp1 = 0.0f;
float angleLamp2 = 0.0f;
float angleLamp3 = 0.0f;
...
void drawTeapot() {
	...
	static Obj3D teapot("teapot.obj");
...
int main(void)
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		Projection = glm::perspective(45.0f, 4.0f / 3.0f, 0.1f, 5.0f);
		...
		Model = glm::rotate(Model, angleLampZ, glm::vec3(1, 0, 0));
		Model = glm::rotate(Model, angleLamp1, glm::vec3(0, 1, 0));
		Model = glm::translate(Model, glm::vec3(0, 0, 0.5f));		
		drawSeg(0.5f);
		Model = glm::translate(Model, glm::vec3(0, 0, 0.5f));
		Model = glm::rotate(Model, angleLamp2, glm::vec3(0, 1, 0));
		Model = glm::translate(Model, glm::vec3(0, 0, 0.4f));
		drawSeg(0.4f);
		Model = glm::translate(Model, glm::vec3(0, 0, 0.4f));
		Model = glm::rotate(Model, angleLamp3, glm::vec3(0, 1, 0));
		Model = glm::translate(Model, glm::vec3(0, 0, 0.3f));
		drawSeg(0.3f);
